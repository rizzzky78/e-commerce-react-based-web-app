...
/* Lists All of Products and Picture Property */


let MyProducts = [
    {
    name: "Carnocap",
    thumbnail: 'https://hni.net/public/front/img/produk/CARNOCAP-1_04-01-19_.png',
    price: 12345,
...
let MyContent = () => {
    return `Excepteur veniam sint sint cupidatat nisi incididunt nisi. Enim enim aliquip cillum ut. Consectetur id ipsum ut nostrud eiusmod tempor Lorem excepteur duis dolore anim.
